...
mainroads AS (
	...
	FROM imgeo.wegdeel_2dactueelbestaand a
	LEFT JOIN imgeo.overbruggingsdeel_2dactueelbestaand b
...
auxroads AS (
	...
	FROM imgeo.ondersteunendwegdeel_2dactueelbestaand, bounds
...
tunnels AS (
	...
	FROM imgeo.tunneldeel_2dactueelbestaand, bounds
